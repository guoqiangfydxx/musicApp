    ...
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          <scroll ref="listScroll" v-if="currentIndex === 0" :data="playHistory" class="list-scroll">
            <div class="list-inner">
              <song-list :songs="playHistory" @select="selectSongList"></song-list>
            </div>
          </scroll>
          <scroll ref="searchList" v-show="currentIndex === 1" :data="searchHistory" class="list-scroll" :refreshDelay="refreshDelay">
            <div class="list-inner">
